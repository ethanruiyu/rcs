"""
Django settings for rcs project.
...
SECRET_KEY = 'django-insecure--v2ms(pl8)k9dwb25avs_&)6tfjbp&ddj6)(t=p%20af1jg-74'
...
WSGI_APPLICATION = 'rcs.wsgi.application'
